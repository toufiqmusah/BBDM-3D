...
def parse_args_and_config():
    ...
    parser.add_argument('-c', '--config', type=str, default='c2v.yaml', help='Path to the config file')
    parser.add_argument('-s', '--seed', type=int, default=6666, help='Random seed')
    ...
    parser.add_argument('--save_best_val', action='store_true', default=False, help="save checkpoint with best performance on val")
